# tmux send-keys -t 0:6.1 'du -h --max-depth=1' Enter
# tmux split-window -h -t 0:6.1 && tmux kill-pane -t 0:6.1 # 2022年 02月 11日 星期五 13:17:11 CST
...
tmux send-keys -t 0:5.2 'cd ~/bin && ./natapp -authtoken=a68ecc5e95588337' Enter  #  xxxxx pppp   xxxxx
